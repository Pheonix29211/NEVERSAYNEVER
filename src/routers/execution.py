    ...
    async def execute_buy(
        ...
        try:
            ...
            if msg_bytes is None:
                msg_bytes = bytes(tx_unsigned.message)

            sig = kp_solders.sign_message(msg_bytes)
            tx_signed = SVT(tx_unsigned.message, [sig])
        ...
        return {"ok": False, "reason": "tx_sign_failed"}
